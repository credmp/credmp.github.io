...
(dolist (pkg '(dash projectile org org-contrib yaml-mode htmlize php-mode clojure-mode haskell-mode rust-mode))
...
(defvar duncan--publish-project-alist
  (list
   ...
   (list "site"
         ...
         :html-head-include-default-style nil)
   (list "writeups"
         :base-directory "./writeups"
         :base-extension "org"
         :recursive t
         :publishing-directory "./public/writeups"
         :publishing-function 'duncan/org-html-publish-site-to-html
